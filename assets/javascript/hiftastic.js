...
playersRef.on("value", function(snapshot) {
  ...
  if (jugador1Exists) {
    $("#player1-name").text(jugador1Data.name);
    $("#player1-wins").text("Wins: " + jugador1Data.wins);
    $("#player1-losses").text("Losses: " + jugador1Data.losses);
  }
  else {
  ...
  if (jugador2Exists) {
    $("#player2-name").text(jugador2Data.name);
    $("#player2-wins").text("Wins: " + jugador2Data.wins);
    $("#player2-losses").text("Losses: " + jugador2Data.losses);
  }
  else {
  ...
  if (playerNum) {
    ...
    if (currentTurn === 1) {
      ...
      if (currentTurn === playerNum) {
        ...
        $("#current-turn").html("<h2>Waiting for " + jugador1Data.name + " to choose.</h2>");
      }
      ...
      if (currentTurn === playerNum) {
        ...
        $("#current-turn").html("<h2>Waiting for " + jugador2Data.name + " to choose.</h2>");
      }
      // Shows yellow border around active player
      ...
      $("#player1-chosen").html(jugador1Data.choice);
      $("#player2-chosen").html(jugador2Data.choice);
      //  reset after timeout
      var moveOn = function() {
...
function gameLogic(player1choice, player2choice) {
  var jugador1Won = function() {
    $("#result").html("<h2>" + jugador1Data.name + "</h2><h2>Wins!</h2>");
    if (playerNum === 1) {
  ...
  var jugador2Won = function() {
    $("#result").html("<h2>" + jugador2Data.name + "</h2><h2>Wins!</h2>");
    if (playerNum === 2) {
